...
from .attention_processor import DDCAAttnProcessor
...
class DDCA():
    ...
    def __init__(self, 
        ...
        self.load_ip_adapter()
        #self.pipe.unet.attn_processors.eval()
        torch.nn.ModuleList(self.pipe.unet.attn_processors.values()).eval()
        #print(next(torch.nn.ModuleList(self.pipe.unet.attn_processors.values()).parameters()).dtype)
